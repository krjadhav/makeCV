...
Mistakes to avoid when writing tests. Following strict TDD prevents these.
...
BEFORE asserting on any mock element:
  ...
  IF testing mock existence: STOP - Delete the assertion
```
...
BEFORE mocking any method:
  ...
  3. IF depends on side effects: Mock at lower level
```
...
BEFORE creating mock responses:
  1. Check: "What fields does the real API response contain?"
